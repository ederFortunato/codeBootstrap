				...
				*/
				...
				if($lastpage > 1){
						if($this->page){
								//anterior button
								if($this->page > 1)
										$this->pagination .= "<li><a href=\"".$this->get_pagenum_link($prev)."\" class=\"previous\">$p</a></li>";
									else
										$this->pagination .= "<li class=\"disabled\"><a>$p</a></li>";
							}
						//pages	
						if ($lastpage < 7 + ($this->adjacents * 2)){//not enough pages to bother breaking it up
								for ($counter = 1; $counter <= $lastpage; $counter++){
										if ($counter == $this->page)
												$this->pagination .= "<li class=\"active\"><a>$counter</a></li>";
											else
						...
						elseif($lastpage > 5 + ($this->adjacents * 2)){//enough pages to hide some
								...
								elseif($lastpage - ($this->adjacents * 2) > $this->page && $this->page > ($this->adjacents * 2)){
										...
										$this->pagination .= "<li><a href=\"".$this->get_pagenum_link(2)."\">2</a><li></li>";
										$this->pagination .= "...";
						...
						if($this->page){
								...
								if ($this->page < $counter - 1)
										...
										$this->pagination .= "<li class=\"disabled\"><a>$n</a><li>";
									if($this->showCounter)$this->pagination .= "<li><div class=\"pagination_data\">($this->total_pages Pages)</div></li>";
							}
					}
